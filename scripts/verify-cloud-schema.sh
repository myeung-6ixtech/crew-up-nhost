...
missing=0
for field in events threads thread_participants presence profiles airlines activities connections rosters notifications messages user_trips flight_instances trip_flight_legs trip_stays trip_matches; do
