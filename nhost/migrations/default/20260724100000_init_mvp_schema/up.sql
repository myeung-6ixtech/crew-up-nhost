...
-- Idempotent: safe to re-run after a partial failed deploy.
...
DROP TRIGGER IF EXISTS airlines_set_updated_at ON public.airlines;
...
CREATE INDEX IF NOT EXISTS profiles_airline_id_idx ON public.profiles (airline_id);
...
DROP TRIGGER IF EXISTS verifications_sync_profile_verified ON public.verifications;
...
CREATE INDEX IF NOT EXISTS rosters_user_layover_idx ON public.rosters (user_id, layover_start, layover_end);
...
CREATE INDEX IF NOT EXISTS presence_city_dates_idx ON public.presence (city, date_start, date_end);
CREATE INDEX IF NOT EXISTS presence_user_id_idx ON public.presence (user_id);
CREATE INDEX IF NOT EXISTS presence_user_dates_idx ON public.presence (user_id, date_start, date_end);
...
CREATE INDEX IF NOT EXISTS connections_addressee_id_idx ON public.connections (addressee_id);
...
CREATE INDEX IF NOT EXISTS event_attendees_status_idx ON public.event_attendees (event_id, status);
...
CREATE UNIQUE INDEX IF NOT EXISTS threads_event_id_unique
...
CREATE INDEX IF NOT EXISTS reports_open_created_at_idx ON public.reports (created_at)
